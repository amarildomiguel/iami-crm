...
return [
    ...
    'quotes' => [
        'index' => [
            ...
            'pdf' => [
                ...
                'grand-total'            => 'Total com IVA',
                'person'                 => 'Cliente',
                'price'                  => 'Preço Unit.',
                'product-name'           => 'Serviço Jurídico',
                'quantity'               => 'Qtd.',
                'quote-id'               => 'Nº da Proposta',
                ...
                // IVA — Fase 6 Conformidade Legal (Lei n.º 7/19)
                'sub-total-before-iva'   => 'Base Tributável (IVA)',
                'iva'                    => 'IVA :rate (Lei n.º 7/19)',
                'iva-exempt'             => 'Isento de IVA',
                'iva-exempt-label'       => 'Isento',
                'iva-exempt-reason'      => 'Motivo da isenção',
            ],
        ],
        'create' => [
            'title'                         => 'Nova Proposta de Honorários',
            'save-btn'                       => 'Guardar Proposta',
            'quote-info'                     => 'Informações da Proposta',
            'quote-info-info'                => 'Dados básicos da proposta de honorários.',
            'address-info'                   => 'Informações de Morada',
            'address-info-info'              => 'Morada relacionada com esta proposta.',
            'quote-items'                    => 'Serviços Jurídicos',
            'search-products'                => 'Pesquisar Serviços',
            'link-to-lead'                   => 'Associar a um Processo',
            'quote-item-info'                => 'Adicionar serviços jurídicos a esta proposta.',
            'quote-name'                     => 'Assunto da Proposta',
            'quantity'                       => 'Qtd.',
            'price'                          => 'Preço Unit.',
            'discount'                       => 'Desconto',
            'tax'                            => 'Outros Impostos',
            'total'                          => 'Total',
            'amount'                         => 'Valor',
            'add-item'                       => '+ Adicionar Serviço',
            'sub-total'                      => 'Subtotal (:symbol)',
            'total-discount'                 => 'Desconto (:symbol)',
            'total-tax'                      => 'Outros Impostos (:symbol)',
            'total-adjustment'               => 'Ajuste (:symbol)',
            'grand-total'                    => 'Total com IVA (:symbol)',
            'discount-amount'                => 'Valor do Desconto',
            'tax-amount'                     => 'Valor dos Impostos',
            'adjustment-amount'              => 'Ajuste',
            'product-name'                   => 'Serviço Jurídico',
            'action'                         => 'Acção',
            // IVA — Fase 6 Conformidade Legal (Lei n.º 7/19)
            'iva-exempt'                     => 'Isento de IVA',
            'iva-exempt-reason-placeholder'  => 'Motivo da isenção de IVA (ex: art. 12.º do Código do IVA)',
            'iva-rate'                       => 'IVA (Lei n.º 7/19)',
            'iva-percentage'                 => 'Taxa de IVA (%)',
            'iva-amount'                     => 'IVA (:symbol)',
        ],
        'edit' => [
            'title'                         => 'Editar Proposta de Honorários',
            'save-btn'                       => 'Guardar Proposta',
            'quote-info'                     => 'Informações da Proposta',
            'quote-info-info'                => 'Dados básicos da proposta de honorários.',
            'address-info'                   => 'Informações de Morada',
    ...
    'leads' => [
        ...
        // Fase 6 — Controlo de Acesso por Processo (Lei n.º 22/11 / Estatuto OAA)
        'view' => [
            'unauthorized' => 'Acesso não autorizado. Apenas pode visualizar processos que lhe foram atribuídos.',
        ],
        'file'            => [
    ...
    |--------------------------------------------------------------------------
    |
    | Mensagens e rótulos relativos à conformidade legal em Angola:
    | - Lei n.º 22/11 (Protecção de Dados Pessoais)
    | - Lei n.º 7/19 (Código do IVA) — taxa de 14%
    | - Estatuto da OAA (Ordem dos Advogados de Angola)
    ...
    */
    'legal-compliance' => [
        ...
        'data-protection' => [
            ...
            'consent-required'          => 'É necessário obter o consentimento do titular dos dados antes de registar informações pessoais.',
            'consent-given'             => 'Consentimento obtido',
            'consent-revoked'           => 'Consentimento revogado',
            'consent-date'              => 'Data do Consentimento',
            'consent-source'            => 'Origem do Consentimento',
            ...
            'revoke-confirm'            => 'Tem a certeza que deseja revogar o consentimento deste cliente? Esta acção não pode ser desfeita.',
            'retention-period'          => 'Período de Conservação dos Dados',
            'data-subject-rights'       => 'Direitos do Titular dos Dados',
            'right-to-access'           => 'Direito de Acesso',
            'right-to-rectification'    => 'Direito de Rectificação',
            'right-to-erasure'          => 'Direito ao Apagamento',
            'right-to-portability'      => 'Direito à Portabilidade',
            'privacy-notice'            => 'Aviso de Privacidade',
        ],

        // IVA — Lei n.º 7/19 (Código do IVA Angola)
        'iva' => [
            'title'                     => 'IVA — Imposto sobre o Valor Acrescentado',
            'rate'                      => 'Taxa de IVA',
            'standard-rate'             => 'Taxa Padrão: 14%',
            'exempt'                    => 'Isento de IVA',
            'exempt-reason'             => 'Motivo da Isenção',
            'regime-normal'             => 'Regime Normal',
            'regime-simplificado'       => 'Regime Simplificado',
            'regime-isencao'            => 'Regime de Isenção',
            'nif-required'              => 'O NIF é obrigatório para emissão de facturas (Art. 37.º do Código do IVA).',
            'nif-invalid'               => 'O NIF introduzido não é válido.',
        ],

        // Acesso e Sigilo Profissional — Estatuto OAA
        'access-control' => [
            'title'                     => 'Controlo de Acesso por Processo',
            'unauthorized'              => 'Acesso não autorizado a este processo.',
            'confidential'              => 'Processo Confidencial',
            'restricted-access'         => 'Acesso Restrito',
            'view-permission-global'    => 'Administrador — acesso total',
            'view-permission-group'     => 'Supervisor — acesso ao departamento',
            'view-permission-individual'=> 'Advogado — apenas processos atribuídos',
            'intern-readonly'           => 'Estagiário — somente leitura',
            'sigilo-profissional'       => 'Sigilo Profissional (Art. 74.º Estatuto OAA)',
        ],

        // Campos Obrigatórios por Lei
        'required-fields' => [
            'nif'                       => 'NIF (Número de Identificação Fiscal)',
            'nif-required-billing'      => 'O NIF é obrigatório para emissão de facturas acima do limite legal.',
            'bi-number'                 => 'Bilhete de Identidade (BI)',
            'time-tracking'             => 'Registo de Horas',
            'time-tracking-required'    => 'O registo de horas é obrigatório para justificação de honorários (Estatuto OAA).',
        ],
    ],
];
